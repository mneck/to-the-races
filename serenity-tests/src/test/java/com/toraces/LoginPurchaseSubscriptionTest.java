...
public class LoginPurchaseSubscriptionTest {
    ...
    @Test
    void loginAndPurchaseSubscription() {
        String email = "purchase" + randomSuffix + "@example.com";
        
        // Register user
        user.wasAbleTo(
            Open.url("http://localhost:3000/register"),
            Enter.theValue("Purchase User").into(NAME_INPUT),
            Enter.theValue("purchaseuser" + randomSuffix).into(USERNAME_INPUT),
